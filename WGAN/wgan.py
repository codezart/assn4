...
def main(dataset, latent_space_dm):
	...
	for epoch in range(epochs):
		...
		epoch_emd = (em_distance/ (k*bi)).item()
	...
	plt.xlabel('Epoch')
	plt.ylabel('Loss')
	plt.title('WGAN {dataset} BCE (Binary Cross Entropy) loss {latent_space_dm}')
	plt.savefig(f"plots/{dataset}/wgan_{latent_space_dm}_bce.png")
	plt.close()
	...
	plt.title('WGAN_{dataset}_JSD_{latent_space_dm}')
	plt.savefig(f"plots/{dataset}/wgan_{latent_space_dm}_jsd.png")
	plt.close()
...
if __name__=="__main__":
	...
	for dataset in datasets:
		for latent_space_dm in latent_space_dms:
			...
			logfilename=f"../logs/{dataset}_WGAN_{latent_space_dm}.log"
